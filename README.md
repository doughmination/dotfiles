...
Older versions of ESAL can be found in the [Licence Archive](./licence-archive/) named "LICENCE-version.md", with the root [LICENCE.md](./LICENCE.md) contains the current ESAL version (1.4)
