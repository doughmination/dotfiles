...
Rectangle {
    ...
    id: root; width: Screen.width; height: Screen.height; color: "#040A10"
    ...
    readonly property color winAmber: "#FDF500"
    ...
    Repeater {
        ...
        delegate: Item {
            ...
            Rectangle { anchors.fill: parent; gradient: Gradient { GradientStop { position: 0.0; color: "transparent" } GradientStop { position: 1.0; color: "#801AC5B0" } } }
            SequentialAnimation {
    ...
    Column {
        ...
        Text { id: err; text: ""; color: "#FB3048"; anchors.horizontalCenter: parent.horizontalCenter; font.family: pf.name; font.pixelSize: 12 * s }
    }
